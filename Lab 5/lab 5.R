getwd()
setwd("C:\\Users\\sisil\\Desktop\\SLIIT\\2nd year\\2nd sem\\2nd Sem\\Probability and Statics\\Labs\\Lab 5")
getwd()
...
hist(x2, main= "Histogram for number od shareholders" , xlab = "no of share holders")

#q2 - Draw a histogram using seven classes where the lower limit is 130 and an upper limit of 270
histogram<-hist(x2, main= "Histogram for number od shareholders" , xlab = "no of share holders", breaks = seq(130,270,length=8), right = FALSE)
...
#draw in new plot
plot(mids,freq, type = "l" , main ="Frequency polygon for number of shareholders")
...
plot(breaks,new(),type = "o" , main ="Frequency polygon for number of shareholders")
